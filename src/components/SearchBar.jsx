...
import { setSearchQuery, setSortOption, setActiveCategory } from '../store/slices/recipeSlice'
...
function SearchBar() {
  ...
  const { searchQuery, sortOption, activeCategory } = useSelector(state => state.recipes)
